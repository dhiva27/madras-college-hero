          ...
          >
            <CarouselContent>
              ...
              <CarouselItem className="md:basis-1/2 lg:basis-1/3">
                <div className="group relative bg-gradient-to-br from-pink-100 to-pink-200 rounded-3xl p-8 overflow-hidden hover:shadow-xl transition-all duration-300 cursor-pointer h-full">
              ...
              <CarouselItem className="md:basis-1/2 lg:basis-1/3">
                <div className="group relative bg-gradient-to-br from-blue-100 to-blue-200 rounded-3xl p-8 overflow-hidden hover:shadow-xl transition-all duration-300 cursor-pointer h-full">
                  <div className="absolute top-4 right-4 w-32 h-32 bg-white/20 rounded-full blur-2xl" />
                  <div className="relative z-10">
                    <div className="w-24 h-24 bg-white/40 rounded-2xl mb-6 flex items-center justify-center">
                      <span className="text-4xl">📱</span>
              ...
              <CarouselItem className="md:basis-1/2 lg:basis-1/3">
                <div className="group relative bg-gradient-to-br from-purple-100 to-purple-200 rounded-3xl p-8 overflow-hidden hover:shadow-xl transition-all duration-300 cursor-pointer h-full">
                  <div className="absolute top-4 right-4 w-32 h-32 bg-white/20 rounded-full blur-2xl" />
                  <div className="relative z-10">
                    <div className="w-24 h-24 bg-white/40 rounded-2xl mb-6 flex items-center justify-center">
                      <span className="text-4xl">🏠</span>
              ...
              {/* Beauty Category */}
              <CarouselItem className="md:basis-1/2 lg:basis-1/3">
                <div className="group relative bg-gradient-to-br from-amber-100 to-amber-200 rounded-3xl p-8 overflow-hidden hover:shadow-xl transition-all duration-300 cursor-pointer h-full">
                  <div className="absolute top-4 right-4 w-32 h-32 bg-white/20 rounded-full blur-2xl" />
                  <div className="relative z-10">
                    <div className="w-24 h-24 bg-white/40 rounded-2xl mb-6 flex items-center justify-center">
                      <span className="text-4xl">💄</span>
              ...
              {/* Sports Category */}
              <CarouselItem className="md:basis-1/2 lg:basis-1/3">
                <div className="group relative bg-gradient-to-br from-green-100 to-green-200 rounded-3xl p-8 overflow-hidden hover:shadow-xl transition-all duration-300 cursor-pointer h-full">
                  <div className="absolute top-4 right-4 w-32 h-32 bg-white/20 rounded-full blur-2xl" />
                  <div className="relative z-10">
                    <div className="w-24 h-24 bg-white/40 rounded-2xl mb-6 flex items-center justify-center">
                      <span className="text-4xl">⚽</span>
              ...
              {/* Lifestyle Category */}
              <CarouselItem className="md:basis-1/2 lg:basis-1/3">
                <div className="group relative bg-gradient-to-br from-rose-100 to-rose-200 rounded-3xl p-8 overflow-hidden hover:shadow-xl transition-all duration-300 cursor-pointer h-full">
                  <div className="absolute top-4 right-4 w-32 h-32 bg-white/20 rounded-full blur-2xl" />
                  <div className="relative z-10">
                    <div className="w-24 h-24 bg-white/40 rounded-2xl mb-6 flex items-center justify-center">
                      <span className="text-4xl">✨</span>
